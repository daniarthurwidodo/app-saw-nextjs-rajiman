...
import { CreateSubtaskRequest, UpdateSubtaskRequest, SubtasksError, PaginationParams, SubtaskFilters } from './types';
...
export class SubtasksController {
  ...
  static async getSubtasksByTask(request: NextRequest, params: { id: string }): Promise<NextResponse> {
    try {
